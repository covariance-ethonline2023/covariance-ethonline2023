    ...
    <div className="bg-gray-800 text-white w-72 h-[calc(100vh-56px)] overflow-y-auto flex flex-col">
      <div className="p-4">
        <ul className="space-y-2">
          <li className={`p-2 rounded ${currentRoute === "/dashboard/my-campaigns" ? "bg-gradient-to-tr from-indigo-200 to-indigo-100 text-indigo-800" :  "hover:bg-indigo-50 text-gray-600"}`}>
