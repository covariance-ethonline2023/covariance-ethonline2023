...
const Sidebar = () => {
  ...
  return (
    <div className="bg-appGlass text-white w-100 text-16 pt-16 pl-8 flex-initial w-[280px] overflow-y-auto flex flex-col">
      <div>
        <ul className="space-y-2">
          <li className={`p-2 mb-4 rounded ${itemClass("my-campaigns")}`}>
            <Link className="flex items-center" href="/dashboard/my-campaigns">
            <svg className="flex-initial mr-4" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className={`p-2 rounded ${itemClass("find-campaigns")}`}>
            ...
            <svg className="flex-initial mr-4" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
